...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [ISSUE-001](issues/ISSUE-001.md) | neo4j: Cypher snapshot materializes complete output string | PR-Ready | Pull-Request-Implementation | New-pull-request | Medium | Approve exact PR draft | Not published. |
| [ISSUE-002](issues/ISSUE-002.md) | neo4j: row sorting rebuilds composite keys per comparison | PR-Ready | Pull-Request-Implementation | New-pull-request | Medium | Approve exact PR draft | Not published. |
| [ISSUE-003](issues/ISSUE-003.md) | call graph: both resolvers rebuild the same AST index | PR-Ready | Pull-Request-Implementation | New-pull-request | Medium | Approve exact PR draft | Not published. |
| [ISSUE-004](issues/ISSUE-004.md) | cache: warm level-one hits still construct compiler projects | PR-Ready | Pull-Request-Implementation | New-pull-request | Medium | Approve exact PR draft | Not published. |
| [ISSUE-005](issues/ISSUE-005.md) | dataflow: throwability scans each subtree up to four times | PR-Ready | Pull-Request-Implementation | New-pull-request | Low | Approve exact PR draft | Not published. |
| [ISSUE-006](issues/ISSUE-006.md) | artifacts: unmatched text files decode twice | PR-Ready | Pull-Request-Implementation | New-pull-request | Low | Approve exact PR draft | Not published. |
