  ...
  {f: 'can://typescript/anon-app/src/routes.ts/login/<anon@2:10>', t: 'can://typescript/anon-app/src/routes.ts/query', p: {weight: 2, prov: ['tsc', 'jelly']}},
  ...
  {f: 'can://typescript/anon-app/src/routes.ts/outer/<anon@20:10>/<anon@20:16>', t: 'can://typescript/anon-app/src/routes.ts/named', p: {weight: 1, prov: ['jelly']}}
